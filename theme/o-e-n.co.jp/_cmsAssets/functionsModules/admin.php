...
add_filter( 'acf/fields/wysiwyg/toolbars' , 'jobs_toolbars'  );
function jobs_toolbars( $toolbars )
{
	$toolbars['jobs_toolbars'] = array();
	$toolbars['jobs_toolbars'][1] = array('bold', 'link','unlink');
